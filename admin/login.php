...
<head>
    ...
    <title>Login to Warteg Kirara</title>
  <!-- BOOTSTRAP STYLES-->
    ...
    <div class="container">
        <div class="row text-center ">
            <div class="col-md-12">
                ...
                <h5><font color="black">( Login via Admin )</font></h5>
                 <br />
            </div>
        </div>
         <div class="row ">
                        ...
                        <strong>Enter Details To Login</strong>  
                            ...
                            <div class="panel-body">
                                <form role="form" method="post">
                                     ...
                                     <button class="btn btn-primary" name="login"><i class="glyphicon glyphicon-log-in"></i> Login</button>
                                    <?php  
